...
#ifndef FLATBUFFERS_GENERATED_SKILLREFERENCEFB_GAME_OBJECT_FBSKILL_H_
#define FLATBUFFERS_GENERATED_SKILLREFERENCEFB_GAME_OBJECT_FBSKILL_H_
...
struct FB_Skill FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const Game::Object::fbSkill::FB_PointSkillDistribution *point_skill_distr() const {
    return GetStruct<const Game::Object::fbSkill::FB_PointSkillDistribution *>(VT_POINT_SKILL_DISTR);
  }
  const Game::Object::fbSkill::FB_AutomaticWeaponsDistribution *automatic_distr() const {
    return GetStruct<const Game::Object::fbSkill::FB_AutomaticWeaponsDistribution *>(VT_AUTOMATIC_DISTR);
  }
  const Game::Object::fbSkill::FB_BigGunsDistribution *big_guns_distr() const {
    return GetStruct<const Game::Object::fbSkill::FB_BigGunsDistribution *>(VT_BIG_GUNS_DISTR);
  }
  const Game::Object::fbSkill::FB_BrawlingDistribution *brawling_distr() const {
    return GetStruct<const Game::Object::fbSkill::FB_BrawlingDistribution *>(VT_BRAWLING_DISTR);
  }
  const Game::Object::fbSkill::FB_MeleeCombatDistribution *melee_distr() const {
    return GetStruct<const Game::Object::fbSkill::FB_MeleeCombatDistribution *>(VT_MELEE_DISTR);
  }
  const Game::Object::fbSkill::FB_SmallArmsDistribution *small_arms_distr() const {
    return GetStruct<const Game::Object::fbSkill::FB_SmallArmsDistribution *>(VT_SMALL_ARMS_DISTR);
  }
  const Game::Object::fbSkill::FB_SniperDistribution *sniper_distr() const {
    return GetStruct<const Game::Object::fbSkill::FB_SniperDistribution *>(VT_SNIPER_DISTR);
  }
  const Game::Object::fbSkill::FB_AnimalWhispererDistribution *animal_whisperer_disrt() const {
    return GetStruct<const Game::Object::fbSkill::FB_AnimalWhispererDistribution *>(VT_ANIMAL_WHISPERER_DISRT);
  }
  const Game::Object::fbSkill::FB_ExplosivesDistribution *explosives_distr() const {
    return GetStruct<const Game::Object::fbSkill::FB_ExplosivesDistribution *>(VT_EXPLOSIVES_DISTR);
  }
  const Game::Object::fbSkill::FB_FirstAidDistribution *first_aid_distr() const {
    return GetStruct<const Game::Object::fbSkill::FB_FirstAidDistribution *>(VT_FIRST_AID_DISTR);
  }
  const Game::Object::fbSkill::FB_SneakyShitDistribution *sneaky_shit_distr() const {
    return GetStruct<const Game::Object::fbSkill::FB_SneakyShitDistribution *>(VT_SNEAKY_SHIT_DISTR);
  }
  const Game::Object::fbSkill::FB_WeirdScienceDistribution *weird_science_distr() const {
    return GetStruct<const Game::Object::fbSkill::FB_WeirdScienceDistribution *>(VT_WEIRD_SCIENCE_DISTR);
  }
  const Game::Object::fbSkill::FB_MechanicsDistribution *mechanics_distr() const {
    return GetStruct<const Game::Object::fbSkill::FB_MechanicsDistribution *>(VT_MECHANICS_DISTR);
  }
  const Game::Object::fbSkill::FB_SurvivalDistribution *survival_distr() const {
    return GetStruct<const Game::Object::fbSkill::FB_SurvivalDistribution *>(VT_SURVIVAL_DISTR);
  }
  const Game::Object::fbSkill::FB_WeaponModdingDistribution *weapon_modding_distr() const {
    return GetStruct<const Game::Object::fbSkill::FB_WeaponModdingDistribution *>(VT_WEAPON_MODDING_DISTR);
  }
  const Game::Object::fbSkill::FB_BarterDistribution *barter_distr() const {
    return GetStruct<const Game::Object::fbSkill::FB_BarterDistribution *>(VT_BARTER_DISTR);
  }
  const Game::Object::fbSkill::FB_LeadershipDistribution *leadership_distr() const {
    return GetStruct<const Game::Object::fbSkill::FB_LeadershipDistribution *>(VT_LEADERSHIP_DISTR);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<Game::Object::fbSkill::FB_PointSkillDistribution>(verifier, VT_POINT_SKILL_DISTR) &&
           VerifyField<Game::Object::fbSkill::FB_AutomaticWeaponsDistribution>(verifier, VT_AUTOMATIC_DISTR) &&
           VerifyField<Game::Object::fbSkill::FB_BigGunsDistribution>(verifier, VT_BIG_GUNS_DISTR) &&
           VerifyField<Game::Object::fbSkill::FB_BrawlingDistribution>(verifier, VT_BRAWLING_DISTR) &&
           VerifyField<Game::Object::fbSkill::FB_MeleeCombatDistribution>(verifier, VT_MELEE_DISTR) &&
           VerifyField<Game::Object::fbSkill::FB_SmallArmsDistribution>(verifier, VT_SMALL_ARMS_DISTR) &&
           VerifyField<Game::Object::fbSkill::FB_SniperDistribution>(verifier, VT_SNIPER_DISTR) &&
           VerifyField<Game::Object::fbSkill::FB_AnimalWhispererDistribution>(verifier, VT_ANIMAL_WHISPERER_DISRT) &&
           VerifyField<Game::Object::fbSkill::FB_ExplosivesDistribution>(verifier, VT_EXPLOSIVES_DISTR) &&
           VerifyField<Game::Object::fbSkill::FB_FirstAidDistribution>(verifier, VT_FIRST_AID_DISTR) &&
           VerifyField<Game::Object::fbSkill::FB_SneakyShitDistribution>(verifier, VT_SNEAKY_SHIT_DISTR) &&
           VerifyField<Game::Object::fbSkill::FB_WeirdScienceDistribution>(verifier, VT_WEIRD_SCIENCE_DISTR) &&
           VerifyField<Game::Object::fbSkill::FB_MechanicsDistribution>(verifier, VT_MECHANICS_DISTR) &&
           VerifyField<Game::Object::fbSkill::FB_SurvivalDistribution>(verifier, VT_SURVIVAL_DISTR) &&
           VerifyField<Game::Object::fbSkill::FB_WeaponModdingDistribution>(verifier, VT_WEAPON_MODDING_DISTR) &&
           VerifyField<Game::Object::fbSkill::FB_BarterDistribution>(verifier, VT_BARTER_DISTR) &&
           VerifyField<Game::Object::fbSkill::FB_LeadershipDistribution>(verifier, VT_LEADERSHIP_DISTR) &&
           verifier.EndTable();
  }
};
...
struct FB_SkillBuilder {
  ...
  void add_point_skill_distr(const Game::Object::fbSkill::FB_PointSkillDistribution *point_skill_distr) {
    fbb_.AddStruct(FB_Skill::VT_POINT_SKILL_DISTR, point_skill_distr);
  }
  void add_automatic_distr(const Game::Object::fbSkill::FB_AutomaticWeaponsDistribution *automatic_distr) {
    fbb_.AddStruct(FB_Skill::VT_AUTOMATIC_DISTR, automatic_distr);
  }
  void add_big_guns_distr(const Game::Object::fbSkill::FB_BigGunsDistribution *big_guns_distr) {
    fbb_.AddStruct(FB_Skill::VT_BIG_GUNS_DISTR, big_guns_distr);
  }
  void add_brawling_distr(const Game::Object::fbSkill::FB_BrawlingDistribution *brawling_distr) {
    fbb_.AddStruct(FB_Skill::VT_BRAWLING_DISTR, brawling_distr);
  }
  void add_melee_distr(const Game::Object::fbSkill::FB_MeleeCombatDistribution *melee_distr) {
    fbb_.AddStruct(FB_Skill::VT_MELEE_DISTR, melee_distr);
  }
  void add_small_arms_distr(const Game::Object::fbSkill::FB_SmallArmsDistribution *small_arms_distr) {
    fbb_.AddStruct(FB_Skill::VT_SMALL_ARMS_DISTR, small_arms_distr);
  }
  void add_sniper_distr(const Game::Object::fbSkill::FB_SniperDistribution *sniper_distr) {
    fbb_.AddStruct(FB_Skill::VT_SNIPER_DISTR, sniper_distr);
  }
  void add_animal_whisperer_disrt(const Game::Object::fbSkill::FB_AnimalWhispererDistribution *animal_whisperer_disrt) {
    fbb_.AddStruct(FB_Skill::VT_ANIMAL_WHISPERER_DISRT, animal_whisperer_disrt);
  }
  void add_explosives_distr(const Game::Object::fbSkill::FB_ExplosivesDistribution *explosives_distr) {
    fbb_.AddStruct(FB_Skill::VT_EXPLOSIVES_DISTR, explosives_distr);
  }
  void add_first_aid_distr(const Game::Object::fbSkill::FB_FirstAidDistribution *first_aid_distr) {
    fbb_.AddStruct(FB_Skill::VT_FIRST_AID_DISTR, first_aid_distr);
  }
  void add_sneaky_shit_distr(const Game::Object::fbSkill::FB_SneakyShitDistribution *sneaky_shit_distr) {
    fbb_.AddStruct(FB_Skill::VT_SNEAKY_SHIT_DISTR, sneaky_shit_distr);
  }
  void add_weird_science_distr(const Game::Object::fbSkill::FB_WeirdScienceDistribution *weird_science_distr) {
    fbb_.AddStruct(FB_Skill::VT_WEIRD_SCIENCE_DISTR, weird_science_distr);
  }
  void add_mechanics_distr(const Game::Object::fbSkill::FB_MechanicsDistribution *mechanics_distr) {
    fbb_.AddStruct(FB_Skill::VT_MECHANICS_DISTR, mechanics_distr);
  }
  void add_survival_distr(const Game::Object::fbSkill::FB_SurvivalDistribution *survival_distr) {
    fbb_.AddStruct(FB_Skill::VT_SURVIVAL_DISTR, survival_distr);
  }
  void add_weapon_modding_distr(const Game::Object::fbSkill::FB_WeaponModdingDistribution *weapon_modding_distr) {
    fbb_.AddStruct(FB_Skill::VT_WEAPON_MODDING_DISTR, weapon_modding_distr);
  }
  void add_barter_distr(const Game::Object::fbSkill::FB_BarterDistribution *barter_distr) {
    fbb_.AddStruct(FB_Skill::VT_BARTER_DISTR, barter_distr);
  }
  void add_leadership_distr(const Game::Object::fbSkill::FB_LeadershipDistribution *leadership_distr) {
...
inline flatbuffers::Offset<FB_Skill> CreateFB_Skill(
    ...
    const Game::Object::fbSkill::FB_PointSkillDistribution *point_skill_distr = 0,
    const Game::Object::fbSkill::FB_AutomaticWeaponsDistribution *automatic_distr = 0,
    const Game::Object::fbSkill::FB_BigGunsDistribution *big_guns_distr = 0,
    const Game::Object::fbSkill::FB_BrawlingDistribution *brawling_distr = 0,
    const Game::Object::fbSkill::FB_MeleeCombatDistribution *melee_distr = 0,
    const Game::Object::fbSkill::FB_SmallArmsDistribution *small_arms_distr = 0,
    const Game::Object::fbSkill::FB_SniperDistribution *sniper_distr = 0,
    const Game::Object::fbSkill::FB_AnimalWhispererDistribution *animal_whisperer_disrt = 0,
    const Game::Object::fbSkill::FB_ExplosivesDistribution *explosives_distr = 0,
    const Game::Object::fbSkill::FB_FirstAidDistribution *first_aid_distr = 0,
    const Game::Object::fbSkill::FB_SneakyShitDistribution *sneaky_shit_distr = 0,
    const Game::Object::fbSkill::FB_WeirdScienceDistribution *weird_science_distr = 0,
    const Game::Object::fbSkill::FB_MechanicsDistribution *mechanics_distr = 0,
    const Game::Object::fbSkill::FB_SurvivalDistribution *survival_distr = 0,
    const Game::Object::fbSkill::FB_WeaponModdingDistribution *weapon_modding_distr = 0,
    const Game::Object::fbSkill::FB_BarterDistribution *barter_distr = 0,
    const Game::Object::fbSkill::FB_LeadershipDistribution *leadership_distr = 0) {
...
inline const Game::Object::fbSkill::FB_Skill *GetFB_Skill(const void *buf) {
  return flatbuffers::GetRoot<Game::Object::fbSkill::FB_Skill>(buf);
}

inline const Game::Object::fbSkill::FB_Skill *GetSizePrefixedFB_Skill(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<Game::Object::fbSkill::FB_Skill>(buf);
}
...
inline bool VerifyFB_SkillBuffer(
  ...
  return verifier.VerifyBuffer<Game::Object::fbSkill::FB_Skill>(FB_SkillIdentifier());
}

inline bool VerifySizePrefixedFB_SkillBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Game::Object::fbSkill::FB_Skill>(FB_SkillIdentifier());
}
...
inline void FinishFB_SkillBuffer(
    ...
    flatbuffers::Offset<Game::Object::fbSkill::FB_Skill> root) {
...
#endif  // FLATBUFFERS_GENERATED_SKILLREFERENCEFB_GAME_OBJECT_FBSKILL_H_
