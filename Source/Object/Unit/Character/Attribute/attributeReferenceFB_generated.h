...
#ifndef FLATBUFFERS_GENERATED_ATTRIBUTEREFERENCEFB_GAME_OBJECT_FBATTRIBUTE_H_
#define FLATBUFFERS_GENERATED_ATTRIBUTEREFERENCEFB_GAME_OBJECT_FBATTRIBUTE_H_
...
struct FB_Attribute FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const Game::Object::fbAttribute::FB_PointAttributeDistribution *point_attr_distr() const {
    return GetStruct<const Game::Object::fbAttribute::FB_PointAttributeDistribution *>(VT_POINT_ATTR_DISTR);
  }
  const Game::Object::fbAttribute::FB_CoordinationDistribution *coord_distr() const {
    return GetStruct<const Game::Object::fbAttribute::FB_CoordinationDistribution *>(VT_COORD_DISTR);
  }
  const Game::Object::fbAttribute::FB_LuckDistribution *luck_distr() const {
    return GetStruct<const Game::Object::fbAttribute::FB_LuckDistribution *>(VT_LUCK_DISTR);
  }
  const Game::Object::fbAttribute::FB_AwarenessDistribution *aware_distr() const {
    return GetStruct<const Game::Object::fbAttribute::FB_AwarenessDistribution *>(VT_AWARE_DISTR);
  }
  const Game::Object::fbAttribute::FB_StrengthDistribution *str_distr() const {
    return GetStruct<const Game::Object::fbAttribute::FB_StrengthDistribution *>(VT_STR_DISTR);
  }
  const Game::Object::fbAttribute::FB_SpeedDistribution *speed_distr() const {
    return GetStruct<const Game::Object::fbAttribute::FB_SpeedDistribution *>(VT_SPEED_DISTR);
  }
  const Game::Object::fbAttribute::FB_IntelligenceDistribution *int_distr() const {
    return GetStruct<const Game::Object::fbAttribute::FB_IntelligenceDistribution *>(VT_INT_DISTR);
  }
  const Game::Object::fbAttribute::FB_CharismaDistribution *cha_distr() const {
    return GetStruct<const Game::Object::fbAttribute::FB_CharismaDistribution *>(VT_CHA_DISTR);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<Game::Object::fbAttribute::FB_PointAttributeDistribution>(verifier, VT_POINT_ATTR_DISTR) &&
           VerifyField<Game::Object::fbAttribute::FB_CoordinationDistribution>(verifier, VT_COORD_DISTR) &&
           VerifyField<Game::Object::fbAttribute::FB_LuckDistribution>(verifier, VT_LUCK_DISTR) &&
           VerifyField<Game::Object::fbAttribute::FB_AwarenessDistribution>(verifier, VT_AWARE_DISTR) &&
           VerifyField<Game::Object::fbAttribute::FB_StrengthDistribution>(verifier, VT_STR_DISTR) &&
           VerifyField<Game::Object::fbAttribute::FB_SpeedDistribution>(verifier, VT_SPEED_DISTR) &&
           VerifyField<Game::Object::fbAttribute::FB_IntelligenceDistribution>(verifier, VT_INT_DISTR) &&
           VerifyField<Game::Object::fbAttribute::FB_CharismaDistribution>(verifier, VT_CHA_DISTR) &&
           verifier.EndTable();
  }
};
...
struct FB_AttributeBuilder {
  ...
  void add_point_attr_distr(const Game::Object::fbAttribute::FB_PointAttributeDistribution *point_attr_distr) {
    fbb_.AddStruct(FB_Attribute::VT_POINT_ATTR_DISTR, point_attr_distr);
  }
  void add_coord_distr(const Game::Object::fbAttribute::FB_CoordinationDistribution *coord_distr) {
    fbb_.AddStruct(FB_Attribute::VT_COORD_DISTR, coord_distr);
  }
  void add_luck_distr(const Game::Object::fbAttribute::FB_LuckDistribution *luck_distr) {
    fbb_.AddStruct(FB_Attribute::VT_LUCK_DISTR, luck_distr);
  }
  void add_aware_distr(const Game::Object::fbAttribute::FB_AwarenessDistribution *aware_distr) {
    fbb_.AddStruct(FB_Attribute::VT_AWARE_DISTR, aware_distr);
  }
  void add_str_distr(const Game::Object::fbAttribute::FB_StrengthDistribution *str_distr) {
    fbb_.AddStruct(FB_Attribute::VT_STR_DISTR, str_distr);
  }
  void add_speed_distr(const Game::Object::fbAttribute::FB_SpeedDistribution *speed_distr) {
    fbb_.AddStruct(FB_Attribute::VT_SPEED_DISTR, speed_distr);
  }
  void add_int_distr(const Game::Object::fbAttribute::FB_IntelligenceDistribution *int_distr) {
    fbb_.AddStruct(FB_Attribute::VT_INT_DISTR, int_distr);
  }
  void add_cha_distr(const Game::Object::fbAttribute::FB_CharismaDistribution *cha_distr) {
...
inline flatbuffers::Offset<FB_Attribute> CreateFB_Attribute(
    ...
    const Game::Object::fbAttribute::FB_PointAttributeDistribution *point_attr_distr = 0,
    const Game::Object::fbAttribute::FB_CoordinationDistribution *coord_distr = 0,
    const Game::Object::fbAttribute::FB_LuckDistribution *luck_distr = 0,
    const Game::Object::fbAttribute::FB_AwarenessDistribution *aware_distr = 0,
    const Game::Object::fbAttribute::FB_StrengthDistribution *str_distr = 0,
    const Game::Object::fbAttribute::FB_SpeedDistribution *speed_distr = 0,
    const Game::Object::fbAttribute::FB_IntelligenceDistribution *int_distr = 0,
    const Game::Object::fbAttribute::FB_CharismaDistribution *cha_distr = 0) {
...
inline const Game::Object::fbAttribute::FB_Attribute *GetFB_Attribute(const void *buf) {
  return flatbuffers::GetRoot<Game::Object::fbAttribute::FB_Attribute>(buf);
}

inline const Game::Object::fbAttribute::FB_Attribute *GetSizePrefixedFB_Attribute(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<Game::Object::fbAttribute::FB_Attribute>(buf);
}
...
inline bool VerifyFB_AttributeBuffer(
  ...
  return verifier.VerifyBuffer<Game::Object::fbAttribute::FB_Attribute>(FB_AttributeIdentifier());
}

inline bool VerifySizePrefixedFB_AttributeBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Game::Object::fbAttribute::FB_Attribute>(FB_AttributeIdentifier());
}
...
inline void FinishFB_AttributeBuffer(
    ...
    flatbuffers::Offset<Game::Object::fbAttribute::FB_Attribute> root) {
...
#endif  // FLATBUFFERS_GENERATED_ATTRIBUTEREFERENCEFB_GAME_OBJECT_FBATTRIBUTE_H_
