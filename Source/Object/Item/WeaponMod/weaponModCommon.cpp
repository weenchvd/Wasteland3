...
WeaponMod__Model toWeaponModModel(fbWeaponMod::FB_WeaponModModel id)
{
    static unordered_map<fbWeaponMod::FB_WeaponModModel, WeaponMod__Model> map{
        ...
        { fbWeaponMod::FB_WeaponModModel_BARREL_PHASE_SILENCER, WeaponMod__Model::BARREL_PHASE_SILENCER },
        { fbWeaponMod::FB_WeaponModModel_BARREL_SOUND_SUPRESSOR, WeaponMod__Model::BARREL_SOUND_SUPRESSOR },
        { fbWeaponMod::FB_WeaponModModel_BARREL_BLAST_MUFFLER, WeaponMod__Model::BARREL_BLAST_MUFFLER },
