...
#ifndef FLATBUFFERS_GENERATED_SKILLFB_FBSKILL_H_
#define FLATBUFFERS_GENERATED_SKILLFB_FBSKILL_H_
...
struct FB_Skill FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    ...
    VT_ARMOR_MODDING_LEVEL = 28,
    VT_LOCKPICKING_LEVEL = 30,
    VT_NERD_STUFF_LEVEL = 32,
    VT_MECHANICS_LEVEL = 34,
    VT_SURVIVAL_LEVEL = 36,
    VT_TOASTER_REPAIR_LEVEL = 38,
    VT_WEAPON_MODDING_LEVEL = 40,
    VT_BARTER_LEVEL = 42,
    VT_HARD_ASS_LEVEL = 44,
    VT_KISS_ASS_LEVEL = 46,
    VT_LEADERSHIP_LEVEL = 48
  };
  ...
  int8_t armor_modding_level() const {
    return GetField<int8_t>(VT_ARMOR_MODDING_LEVEL, 0);
  }
  int8_t lockpicking_level() const {
    return GetField<int8_t>(VT_LOCKPICKING_LEVEL, 0);
  }
  int8_t nerd_stuff_level() const {
    return GetField<int8_t>(VT_NERD_STUFF_LEVEL, 0);
  }
  ...
  int8_t toaster_repair_level() const {
    return GetField<int8_t>(VT_TOASTER_REPAIR_LEVEL, 0);
  }
  ...
  int8_t hard_ass_level() const {
    return GetField<int8_t>(VT_HARD_ASS_LEVEL, 0);
  }
  int8_t kiss_ass_level() const {
    return GetField<int8_t>(VT_KISS_ASS_LEVEL, 0);
  }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<int8_t>(verifier, VT_ARMOR_MODDING_LEVEL) &&
           VerifyField<int8_t>(verifier, VT_LOCKPICKING_LEVEL) &&
           VerifyField<int8_t>(verifier, VT_NERD_STUFF_LEVEL) &&
           VerifyField<int8_t>(verifier, VT_MECHANICS_LEVEL) &&
           VerifyField<int8_t>(verifier, VT_SURVIVAL_LEVEL) &&
           VerifyField<int8_t>(verifier, VT_TOASTER_REPAIR_LEVEL) &&
           VerifyField<int8_t>(verifier, VT_WEAPON_MODDING_LEVEL) &&
           VerifyField<int8_t>(verifier, VT_BARTER_LEVEL) &&
           VerifyField<int8_t>(verifier, VT_HARD_ASS_LEVEL) &&
           VerifyField<int8_t>(verifier, VT_KISS_ASS_LEVEL) &&
...
struct FB_SkillBuilder {
  ...
  void add_armor_modding_level(int8_t armor_modding_level) {
    fbb_.AddElement<int8_t>(FB_Skill::VT_ARMOR_MODDING_LEVEL, armor_modding_level, 0);
  }
  void add_lockpicking_level(int8_t lockpicking_level) {
    fbb_.AddElement<int8_t>(FB_Skill::VT_LOCKPICKING_LEVEL, lockpicking_level, 0);
  }
  void add_nerd_stuff_level(int8_t nerd_stuff_level) {
    fbb_.AddElement<int8_t>(FB_Skill::VT_NERD_STUFF_LEVEL, nerd_stuff_level, 0);
  }
  ...
  void add_toaster_repair_level(int8_t toaster_repair_level) {
    fbb_.AddElement<int8_t>(FB_Skill::VT_TOASTER_REPAIR_LEVEL, toaster_repair_level, 0);
  }
  ...
  void add_hard_ass_level(int8_t hard_ass_level) {
    fbb_.AddElement<int8_t>(FB_Skill::VT_HARD_ASS_LEVEL, hard_ass_level, 0);
  }
  void add_kiss_ass_level(int8_t kiss_ass_level) {
    fbb_.AddElement<int8_t>(FB_Skill::VT_KISS_ASS_LEVEL, kiss_ass_level, 0);
  }
...
inline flatbuffers::Offset<FB_Skill> CreateFB_Skill(
    ...
    int8_t armor_modding_level = 0,
    int8_t lockpicking_level = 0,
    int8_t nerd_stuff_level = 0,
    int8_t mechanics_level = 0,
    int8_t survival_level = 0,
    int8_t toaster_repair_level = 0,
    int8_t weapon_modding_level = 0,
    int8_t barter_level = 0,
    int8_t hard_ass_level = 0,
    int8_t kiss_ass_level = 0,
  ...
  builder_.add_kiss_ass_level(kiss_ass_level);
  builder_.add_hard_ass_level(hard_ass_level);
  builder_.add_barter_level(barter_level);
  builder_.add_weapon_modding_level(weapon_modding_level);
  builder_.add_toaster_repair_level(toaster_repair_level);
  builder_.add_survival_level(survival_level);
  builder_.add_mechanics_level(mechanics_level);
  builder_.add_nerd_stuff_level(nerd_stuff_level);
  builder_.add_lockpicking_level(lockpicking_level);
  builder_.add_armor_modding_level(armor_modding_level);
...
#endif  // FLATBUFFERS_GENERATED_SKILLFB_FBSKILL_H_
